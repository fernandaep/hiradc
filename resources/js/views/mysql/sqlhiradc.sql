...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Jul 2021 pada 11.45
...
CREATE TABLE `k3teams` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `karyawan_nik` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `registers` (`id`, `category_id`, `activity`, `lokasi`, `condition_id`, `threat_id`, `pengendalian`, `possibility_id`, `consequence_id`, `tingkat_resiko`, `status_regulasi`, `aspek_lingkungan`, `peluang`, `resiko`, `resiko_ditoleransi`, `cakupan_resiko`, `status_program`, `program`, `created_at`, `updated_at`) VALUES
(1, 6, 'Harum consequatur ne', 'Pantry', 3, 37, 'belum ada', 4, 2, 'Sedang', 'Aliquip do esse rer', 'Penting', 'Aliquip do esse rer', 'Et laborum Eligendi', 'Tidak', 'Unit Kerja', 'Pengendalian Operasional', NULL, '2021-06-29 20:00:37', '2021-06-29 20:00:37'),
(2, 2, 'Cuci Mobil', 'parkiran', 1, 37, 'belum ada', 5, 1, 'Sedang', NULL, 'Tidak Penting', NULL, NULL, 'Tidak', 'Unit Kerja', 'Pengendalian Operasional', NULL, '2021-06-30 01:26:36', '2021-06-30 01:26:36'),
(3, 2, 'Harum consequatur ne', 'Pantry', 1, 38, 'Ut voluptates reicie', 5, 1, 'Sedang', NULL, 'Tidak Penting', NULL, NULL, 'Tidak', 'Unit Kerja', 'Pengendalian Operasional', NULL, '2021-07-02 02:23:35', '2021-07-02 02:23:35');
