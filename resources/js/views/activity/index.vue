            ...
            <table class="table table-hover">
              <tbody>
                ...
                <tr v-for="activity in activities" :key="activity.id">
                  ...
                  <td>{{ activity.nama }}</td>
                  <td>
                    <a href="#" data-id="activity.id" @click="editModalWindow(activity)">
 ...
 /*  watch: {
  ...
  methods: {
     loadData() {
      ...
      editModalWindow(activity){
        console.log(activity);
           this.editMode = true;
           $('#addNew').modal('show');
           this.form.id = activity.id;
           this.form.nama = activity.nama;
      },
     async store() {
        this.loading=true;
          try {
       ...
       async update() {
          ...
          try {
            let id = this.form.id;
            let updated = await axios.put('api/activity/'+id,this.form)
