                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    ...
                                    <b-button
                                        ...
                                        size="sm"
                                        @click="deleteMitigasi(row.item.id)"
                                    >
    ...
    methods: {
        ...
        openModal(tipe, title, button, item) {
            if (tipe == "edit") {
                ...
                this.form.register_id = item.register_id;
                this.form.program_mitigasi = item.program_mitigasi;
                this.form.possibility_id = item.possibility_id;
                this.form.consequence_id = item.consequence_id;
