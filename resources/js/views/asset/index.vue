            ...
            <div class="card">
              ...
              <template #cell(updated_at)="row">
                ...
                <template #cell(actions)="row">
                  ...
                  <b-button variant="outline-danger" size="sm" @click="deleteAsset(row.item.id)">
     ...
     loadData() {
      ...
      async store() {
         this.$v.form.$touch();
          ...
          try {
            let response =  await axios.post('api/asset',this.form)
      ...
      async update() {
        this.$v.form.$touch();
          ...
          try {
            let id = this.form.id;
            let updated = await axios.put('api/asset/'+id,this.form)
             ...
             this.$swal({
                icon: 'Error',
                title: 'Asset Updated Failed '+e.response.data.errors
              });
      ...
      deleteAsset(id) { 
        this.$swal({
          ...
          if (result.isConfirmed) {
            axios.delete("api/asset/"+id).then(response => {
              this.$swal(
                  'Deleted!',
