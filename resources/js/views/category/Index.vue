                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    >
                                                        ...
                                                        <td>
                                                            {{
                                                                value.lama_pemulihan
                                                            }}
                                                        </td>
                                                        <td>
                                                            {{
                                                                value.lama_penyimpangan
                                                            }}
                                                        </td>
                                                        <td>
                                                            {{
...
export default {
    ...
    methods: {
        ...
        async store2() {
            let cek = await axios.get(
                "api/vulnerability/" + this.form2.vulnerability_id
            );
        ...
        async store3() {
            let cek = await axios.get(
                "api/condition/" + this.form3.condition_id
            );
            //console.log(cek.data.success);
            if (cek.data.success == false) {
                this.$swal({
