                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    ...
                                    <b-button
                                        ...
                                        size="sm"
                                        @click="deleteThreat(row.item.id)"
                                    >
    ...
    methods: {
        ...
        getTerm() {
            axios.get("api/term").then(response => {
                this.terms = Object.values(response.data.data);
                let cat = $.map(this.terms, function(t) {
                    return { label: t.kode+' ( '+t.istilah+' )', value: t.id };
                });
                this.terms=cat; 
        ...
        async update() {
            ...
            try {
                ...
                if (updated.status == 200) {
                    ...
                    this.$swal({
                        icon: "success",
                        title: "Threat Updated successfully"
                    });
                    this.loadData();
                }
            } catch (e) {
                this.$swal({
                    icon: "Error",
                    title: "Threat Updated Failed " + e.response.data.errors
                });
