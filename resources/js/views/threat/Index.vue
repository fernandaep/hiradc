            ...
            <table class="table table-hover">
              <tbody>
                ...
                <tr v-for="threat in threats" :key="threat.id">
                  ...
                  <td>{{ threat.nama }}</td>
                  <td>
                    <a href="#" data-id="threat.id" @click="editModalWindow(threat)">
                      <i class="fa fa-edit blue"></i>
                    </a>
                    |
                    <a href="#" @click="deleteThreat(threat.id)">
 ...
 /*  watch: {
  ...
  methods: {
     loadData() {
      ...
      editModalWindow(threat){
        console.log(threat);
           this.editMode = true;
           $('#addNew').modal('show');
           this.form.id = threat.id;
           this.form.nama = threat.nama;
      },
     async store() {
        this.loading=true;
          try {
